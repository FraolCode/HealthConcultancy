...
function Blogs() {
    ...
    return (
        <>
            ...
            <div className="content pb-20 relative block ">
            <div
                            ...
                            <div className="row blog-grid-row">
                                ...
                                <div className="col-md-6 col-sm-12">
                                    ...
                                    <div className="blog grid-blog">
                                        ...
                                        <a onClick={(e)=>passData(e,item)}> <img className="img-fluid" src={item.img} alt="Post Image" /></a>
                                        </div>
                                        <div className="blog-content">
                                            <ul className="entry-meta meta-item">
                                                <li>
                                                    <div className="post-author">
                                                    <a onClick={(e)=>passData(e,item)}><img src={item.img} alt="Post Author" /> <span>{item.createdBy}</span></a>
                                                    </div>
                                                </li>
